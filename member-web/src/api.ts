...
export function getToken() { return localStorage.getItem('member_token') || '' }
export function setToken(token: string) { localStorage.setItem('member_token', token) }
export function clearToken() { localStorage.removeItem('member_token') }
